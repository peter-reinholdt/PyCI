...
void compute_transition_rdm1(const FullCIWfn &, const FullCIWfn &, const double *, const double *, double *);
...
template<class WfnType>
long add_hci(const SQuantOp &, WfnType &, const double *, const long, const double, const long = -1, const long = -1);
...
pybind11::array_t<double> py_compute_transition_rdm1_fullci(const FullCIWfn &, const FullCIWfn &, const Array<double>, const Array<double>);
...
public:
    ...
    template<class WfnType>
    void perform_Vop_direct(const SQuantOp &, const WfnType &, const long, const long, const double, const double *, double *) const;
